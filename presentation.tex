...
\begin{frame}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    ...
    \begin{figure}[h]
      \centering
      \vspace{-.2in}
      \animategraphics[width=\columnwidth, loop, autoplay]
      {5}{anim/slice-Ex-}{00}{29}
    \end{figure}
    ...
    \begin{figure}[h]
      \centering
      \vspace{-.6in}
      \animategraphics[width=.9\columnwidth, loop, autoplay]
      {5}{anim/3d-E-}{00}{29}
    \end{figure}
...
\begin{frame}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    ...
    \begin{figure}[h]
      \centering
      \animategraphics [width=.6\columnwidth, loop, autoplay, final]
      {5}{anim/slice-By-}{00}{29}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \centering
    \animategraphics[width=.6\columnwidth, loop, autoplay]
    {5}{anim/sliceZ-By-}{00}{29}
    \centering
    \animategraphics[width=.6\columnwidth, loop, autoplay]
    {5}{anim/sliceZ-Bz-}{00}{29}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \centering
    \animategraphics[width=.6\columnwidth, loop, autoplay]
    {5}{anim/sliceZ-Sy-}{00}{29}
    \animategraphics[width=.6\columnwidth, loop, autoplay]
    {5}{anim/sliceZ-Sz-}{00}{29}
  \end{figure}
\end{frame}
